...
//
// BASE_CANONICAL is the canonical of the base model from the IG.dependsOn!
...
ig_json = ig_json.replaceAll("$FMID_PREFIX$", FMID_PREFIX);
ig_json = ig_json.replaceAll("$STANDARDS_STATUS$", STANDARDS_STATUS);
