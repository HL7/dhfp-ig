...
2. The DHFP Project Team conducted an in-depth analysis of the EHR-S FM Release 2.01 to identify functions and criteria relevant to dental health, following which they published DHFP R1 in 2020. The team subsequently released an Errata Version (R1.01) in June 2021 to address updates and clarifications. Upon the release of the HL7 Electronic Health Record System Functional Model (EHR-S FM) Release 2.1.1, the project lead reviewed the document to align DHFP R2 with the HL7 [EHR-S FM R2.1.1](https://build.fhir.org/ig/HL7/ehrsfm-ig/).
...
The scope of this project is to develop an EHR System Dental Health Functional Profile Release 2, referred hereinafter as DHFP R2, by identifying functions and conformance criteria from HL7 Electronic Health Record System Functional Model (EHR-S FM), Release 2.1.1, then modifying and adding to those functions and conformance criteria where appropriate.

The Project uses the Common HL7 Toolset (FHIR implementation guide publisher) to develop, ballot, and publish the DHFP R2.
...
In Dec 2023, EHR-S FM Release 2.1 was balloted and published by ISO. Subsequently, HL7 has balloted and published EHRS-FM Release 2.1.1 in Nov 2025.
